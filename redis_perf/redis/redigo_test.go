...
// BenchmarkStoreInHsetRedigoTcp benchmarks the StoreInHset function using a go-redis
...
// BenchmarkStoreInHsetRedigoUnix benchmarks the StoreInHset function using a go-redis
